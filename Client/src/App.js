...
useEffect(()=> {
  ...
  return (
    ...
    <User/>
      ...
      <Routes>
          <Route path="/2" element={<PrivateRoute><Cars {...{scan, setScan, setFormT, setSubCar, subcar, list:"cars", setList}} /></PrivateRoute>}/>
          <Route path="/3" element={<PrivateRoute><Request {...{scan, setScan, setFormT, setSubCar, subcar, list:"reqs", setList}}/></PrivateRoute>}/>
          <Route path="/4" element={<PrivateRoute><Pulls {...{scan, setScan, setFormT ,setSubCar, subcar, list:"pulls", setList}}/></PrivateRoute>}/>
          <Route path="/5" element={<PrivateRoute><Outnr {...{scan, setScan, setFormT, setSubCar, subcar, list:"outs", setList}}/></PrivateRoute>}/>
          <Route path="/6" element={<PrivateRoute><Completed {...{scan, setScan, setFormT, setSubCar, subcar, list:"comps", setList}}/></PrivateRoute>}/> 
